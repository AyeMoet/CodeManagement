...
class UpcommingMovieListAdapter(private val context: Context,private val mDelegate: MovieViewHolderDelegate) :
    ...
    override fun onCreateViewHolder(
        ...
        return UpcomingMovieListViewHolder(view,mDelegate)
    }
